  ...
  return (
    ...
    <main className="flex flex-col items-center justify-between py-8 md:pt-12 md:pb-28 w-full">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center w-full text-sm md:text-base px-4 gap-6 lg:gap-12">
        ...
        <div id="latest-txs-and-faq" className="flex flex-col items-center gap-4 md:w-[45%] max-w-lg md:max-w-xl w-full">
          ...
          <div className="max-w-xl w-full text-xs md:text-sm shrink-0">
            <div className="mx-auto w-full divide-y divide-black/5 border border-[--dark-blue] rounded-md">
            {
              ...
              <Disclosure key={questionIndex} as="div" className="px-6 py-4 shrink-0 w-full" defaultOpen={false}>
